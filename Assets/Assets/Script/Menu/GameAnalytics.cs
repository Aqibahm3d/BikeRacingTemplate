...
public class GameAnalytics : MonoBehaviour
{
    ...
    {
       // AnalyticsEvent.LevelStart(_levelNUmber); //pass level number like 1,2,3,4....   //---->RF
    ...
    {
        //AnalyticsEvent.LevelComplete(_levelNUmber); //pass level number like 1,2,3,4.... //---->RF
    }
    public void LevelFailedEvent(int _levelNUmber)
    {
        // AnalyticsEvent.LevelFail(_levelNUmber); //pass level number like 1,2,3,4....  //---->RF
    }

    /// Onboarding/First-time User Experience
    public void TutorialStartEvent()
    {
        //AnalyticsEvent.TutorialStart(); //call when tutorial starts //---->RF
    }
    public void TutorialSkipEvent()
    {
        // AnalyticsEvent.TutorialSkip(); //call when tutorial skipped  //---->RF
    }
    public void TutorialCompleteEvent()
    {
        //AnalyticsEvent.TutorialComplete(); //call when tutorial Completed  //---->RF
    }
    public void TutorialStepsEvent(int _stepNumber)
    {
        // AnalyticsEvent.TutorialStep(_stepNumber); //event requires you to pass in steps of tutorial progress , (1,2,3,4..) Must be in increasing order //---->RF
